...
export function NoticeBanner({ notice }: Props) {
  ...
  return (
    <Link
      href={href}
      className="flex flex-row gap-2 w-full p-2.5 rounded-[10px] bg-white text-black border-text-sub2 border transition-all duration-150 active:bg-gray-50 active:scale-[0.99]"
    >
